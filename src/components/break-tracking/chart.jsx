      ...
      <div className={`flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6 gap-3 sm:gap-0 ${isArabic ? "sm:flex-row-reverse" : "sm:flex-row"}`}>
        ...
        <div className="relative flex items-center w-full sm:w-auto justify-end">
          <select
            ...
            className="rounded-full px-4 sm:px-5 py-2 pr-8 sm:pr-10 text-xs sm:text-sm font-semibold appearance-none focus:outline-none transition-all duration-200 hover:scale-105 w-full sm:w-auto"
            style={{
              minWidth: "100px",
              maxWidth: "120px",
          ...
          <ChevronDown
            className={`absolute ${isArabic ? "left-3 sm:left-4" : "right-3 sm:right-4"} top-1/2 transform -translate-y-1/2 w-3 h-3 sm:w-4 sm:h-4`}
            style={{ color: "#fff" }}
          />
        </div>
      </div>
