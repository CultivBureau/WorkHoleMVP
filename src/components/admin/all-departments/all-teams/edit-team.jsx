                                    ...
                                    <div className="relative">
                                        ...
                                        {isLeaderUserOpen && leaderRole && (
                                            <div className="absolute top-full left-0 right-0 z-20 mt-1 bg-[var(--bg-color)] border border-[var(--border-color)] rounded-lg shadow-lg max-h-60 overflow-y-auto">
                                                ...
                                                {(!leaderUsers || leaderUsers.length === 0) && <div className="p-3 text-[var(--sub-text-color)]">{t("allTeams.editTeam.noUsersFound")}</div>}
                                            </div>
                                        )}
                                    </div>
                                </div>
                            ...
                            <span className="text-[var(--sub-text-color)]">
                                    ...
                                    {isMembersOpen && (
                                        ...
                                        >
                                            ...
                                            {membersRole && (!memberUsers || memberUsers.length === 0) && <div className="p-3 text-[var(--sub-text-color)]">{t("allTeams.editTeam.noUsersFound")}</div>}
                                        </div>
                                    )}
                                        </div>
                            </div>
