...
const AttendanceTable = () => {
  ...
  return (
    <div className="w-full p-2 sm:p-4">
      {/* Header */}
      <h1 className="text-lg sm:text-xl text-start font-semibold text-[var(--text-color)] mb-3 sm:mb-4">Attendance Overview</h1>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
          ...
          <div className="flex flex-col min-[480px]:flex-row flex-wrap gap-2 min-[480px]:gap-3 w-full sm:flex-1">
            ...
            <div className="flex flex-col min-[320px]:flex-row min-[320px]:items-center gap-1 min-[320px]:gap-1.5 flex-1 min-[480px]:flex-none min-w-0">
              <span className="text-xs text-[var(--sub-text-color)] whitespace-nowrap min-[320px]:min-w-[70px] min-[480px]:min-w-[60px]">Designation</span>
            ...
            {/* Location Filter */}
            <div className="flex flex-col min-[320px]:flex-row min-[320px]:items-center gap-1 min-[320px]:gap-1.5 flex-1 min-[480px]:flex-none min-w-0">
              <span className="text-xs text-[var(--sub-text-color)] whitespace-nowrap min-[320px]:min-w-[50px] min-[480px]:min-w-[45px]">Location</span>
              <div className="relative flex-1 min-[480px]:flex-none min-w-0">
                <select
            ...
            {/* Status Filter */}
            <div className="flex flex-col min-[320px]:flex-row min-[320px]:items-center gap-1 min-[320px]:gap-1.5 flex-1 min-[480px]:flex-none min-w-0">
              <span className="text-xs text-[var(--sub-text-color)] whitespace-nowrap min-[320px]:min-w-[40px] min-[480px]:min-w-[35px]">Status</span>
              <div className="relative flex-1 min-[480px]:flex-none min-w-0">
                <select
                  value={statusFilter}
          ...
          {employeeData.map((employee, index) => (
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                <div>
                  <span className="text-[var(--sub-text-color)]">Type: </span>
                  <span className="text-[var(--text-color)]">{employee.type}</span>
                </div>
                <div>
                  <span className="text-[var(--sub-text-color)]">Check In: </span>
