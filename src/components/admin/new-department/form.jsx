                            ...
                            return (
                                ...
                                >
                                    <div className={`w-8 h-8 rounded-full flex items-center justify-center ${isArabic ? 'ml-2' : 'mr-2'} ${
                                        ...
                                        isCompleted ? 'bg-[var(--success-color)] text-white' :
                                    ...
                                    <span className={`text-sm font-medium hidden sm:block ${isActive
                                        ? 'gradient-text'
                                        : isCompleted ? 'text-[var(--success-color)]' : 'text-[var(--sub-text-color)]'
                                        }`}>
                                        {stepItem.label}
                                    </span>
                                </div>
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="relative">
                    ...
                    <ChevronDown className={`absolute top-1/2 transform -translate-y-1/2 ${isArabic ? 'left-3' : 'right-3'} text-[var(--sub-text-color)] pointer-events-none`} size={16} />
                </div>
            </div>
